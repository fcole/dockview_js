...
const mockWindow_1 = require("../__mocks__/mockWindow");
class PanelContentPartTest {
    constructor(id, component) {
        this.id = id;
        this.component = component;
        this.element = document.createElement('div');
        this._onDidDispose = new events_1.Emitter();
...
describe('dockviewComponent', () => {
    ...
    beforeEach(() => {
        ...
        dockview = new dockviewComponent_1.DockviewComponent(container, {
    ...
    describe('disableDnd option integration', () => {
        test('that updateOptions with disableDnd updates all tabs and void containers', () => {
            ...
            const tabElements = Array.from(dockview.element.querySelectorAll('.dv-tab'));
            const voidContainers = Array.from(dockview.element.querySelectorAll('.dv-void-container'));
        ...
        test('that new tabs respect current disableDnd option when added after option change', () => {
            ...
            const tabElement = dockview.element.querySelector('.dv-tab');
            const voidContainer = dockview.element.querySelector('.dv-void-container');
    ...
    describe('memory leakage', () => {
        beforeEach(() => {
            window.open = () => (0, mockWindow_1.setupMockWindow)();
        });
        test('event leakage', async () => {
            events_1.Emitter.setLeakageMonitorEnabled(true);
            dockview = new dockviewComponent_1.DockviewComponent(container, {
                createComponent(options) {
                    switch (options.name) {
                        case 'default':
            ...
            dockview.dispose();
            if (events_1.Emitter.MEMORY_LEAK_WATCHER.size > 0) {
                console.warn(`${events_1.Emitter.MEMORY_LEAK_WATCHER.size} undisposed resources`);
                for (const entry of Array.from(events_1.Emitter.MEMORY_LEAK_WATCHER.events)) {
                    console.log('disposal', entry[1]);
                }
                throw new Error(`${events_1.Emitter.MEMORY_LEAK_WATCHER.size} undisposed resources`);
            }
            events_1.Emitter.setLeakageMonitorEnabled(false);
        });
    });
    ...
    test('moveGroupOrPanel with skipSetActive should not activate group/panel', () => {
        ...
        const dockview = new dockviewComponent_1.DockviewComponent(container, {
            createComponent(options) {
                switch (options.name) {
                    case 'default':
                        return new PanelContentPartTest(options.id, options.name);
        ...
        expect(dockview.activeGroup).toBe(group1);
        expect((_a = dockview.activePanel) === null || _a === void 0 ? void 0 : _a.id).toBe(panel2 === null || panel2 === void 0 ? void 0 : panel2.id);
        ...
        expect(dockview.activeGroup).toBe(group1);
        expect((_b = dockview.activePanel) === null || _b === void 0 ? void 0 : _b.id).toBe(panel2 === null || panel2 === void 0 ? void 0 : panel2.id); // panel2 should still be active in group1
    ...
    test('moveGroupOrPanel group move with skipSetActive should not activate group', () => {
        ...
        expect((_a = dockview.activePanel) === null || _a === void 0 ? void 0 : _a.id).toBe(panel1.id);
    ...
    test('panel content added to content-container css check', () => {
        ...
        let viewQuery = container.querySelectorAll('.dv-branch-node > .dv-split-view-container > .dv-view-container > .dv-view');
        expect(viewQuery.length).toBe(1);
        viewQuery = container.querySelectorAll('.dv-branch-node > .dv-split-view-container > .dv-view-container > .dv-view:nth-child(1) >.dv-groupview > .dv-content-container > .testpanel-panel2');
        expect(viewQuery.length).toBe(1);
        ...
        viewQuery = container.querySelectorAll('.dv-branch-node > .dv-split-view-container > .dv-view-container > .dv-view');
        expect(viewQuery.length).toBe(2);
        viewQuery = container.querySelectorAll('.dv-branch-node > .dv-split-view-container > .dv-view-container > .dv-view:nth-child(1) >.dv-groupview > .dv-content-container > .testpanel-panel2');
        expect(viewQuery.length).toBe(1);
        viewQuery = container.querySelectorAll('.dv-branch-node > .dv-split-view-container > .dv-view-container > .dv-view:nth-child(2) >.dv-groupview > .dv-content-container > .testpanel-panel1');
        expect(viewQuery.length).toBe(1);
    });
    describe('serialization', () => {
        ...
        test('serialized layout with maximized node', () => {
            const api = new component_api_1.DockviewApi(dockview);
            api.layout(500, 1000);
            api.addPanel({
                id: 'panel1',
                component: 'default',
        ...
        test('always visible renderer positioning after fromJSON', async () => {
            ...
            const panel2Overlay = overlayContainer.element.querySelector('[data-panel-id]');
            const panel3Overlay = overlayContainer.element.querySelector('[data-panel-id]:not(:first-child)');
    ...
    test('add panel', () => {
        ...
        expect(panel1.api.group).toBe(panel1 === null || panel1 === void 0 ? void 0 : panel1.group);
        ...
        expect(panel1 === null || panel1 === void 0 ? void 0 : panel1.api.isActive).toBeFalsy();
        // expect(panel1?.api.isFocused).toBeFalsy();
        expect(panel1 === null || panel1 === void 0 ? void 0 : panel1.api.isVisible).toBeFalsy();
        expect(panel1.api.isGroupActive).toBeTruthy();
        expect(panel1.api.group.isActive).toBeTruthy();
        const panel2 = dockview.getGroupPanel('panel2');
        ...
        expect(panel2.api.group).toBe(panel2 === null || panel2 === void 0 ? void 0 : panel2.group);
    ...
    test('totalPanels is updated before panel event fires', () => {
        dockview.layout(1000, 1000);
        let counter = 0;
        const disposable = new lifecycle_1.CompositeDisposable(dockview.onDidAddPanel(() => {
            counter++;
    ...
    test('size is updated before group event fires', () => {
        dockview.layout(1000, 1000);
        let counter = 0;
        const disposable = new lifecycle_1.CompositeDisposable(dockview.onDidAddGroup(() => {
            counter++;
    ...
    test('events flow', async () => {
        ...
        dockview.layout(1000, 1000);
        let events = [];
        const disposable = new lifecycle_1.CompositeDisposable(dockview.onDidAddGroup((group) => {
    ...
    test('#1', () => {
        ...
        const removedGroups = [];
        const removedPanels = [];
        const disposable = new lifecycle_1.CompositeDisposable(dockview.onDidRemoveGroup((group) => {
    ...
    test('fromJSON events should still fire', () => {
        ...
        const disposable = new lifecycle_1.CompositeDisposable(dockview.onDidAddGroup((panel) => {
            addGroup.push(panel);
    ...
    test('#2', () => {
        ...
        const viewQuery = group.element.querySelectorAll('.dv-groupview > .dv-tabs-and-actions-container > .dv-scrollable > .dv-tabs-container > .dv-tab');
        expect(viewQuery.length).toBe(2);
        const viewQuery2 = group.element.querySelectorAll('.dv-groupview > .dv-tabs-and-actions-container > .dv-scrollable > .dv-tabs-container > .dv-tab > .dv-default-tab');
        expect(viewQuery2.length).toBe(1);
        const viewQuery3 = group.element.querySelectorAll('.dv-groupview > .dv-tabs-and-actions-container > .dv-scrollable > .dv-tabs-container > .dv-tab > .panel-tab-part-panel2');
    ...
    test('orthogonal realigment #1', () => {
        ...
        dockview.layout(1000, 1000);
        expect(dockview.orientation).toBe(splitview_1.Orientation.HORIZONTAL);
        dockview.fromJSON({
            activeGroup: 'group-1',
            grid: {
                root: {
        ...
        expect(dockview.orientation).toBe(splitview_1.Orientation.VERTICAL);
        dockview.addPanel({
            id: 'panel2',
            component: 'default',
            position: {
    ...
    test('that moving the last panel to be floating should leave an empty gridview', () => {
        ...
        expect(dockview.element.querySelectorAll('.dv-view-container > .dv-view')
            .length).toBe(1);
    ...
    test('that external dnd events do not trigger the top-level center dnd target unless empty', () => {
        ...
        (0, dom_1.fireEvent)(dockview.element, eventCenter);
    ...
    describe('popout group', () => {
        beforeEach(() => {
            jest.spyOn(window, 'open').mockReturnValue((0, shoehorn_1.fromPartial)({
                document: (0, shoehorn_1.fromPartial)({
        ...
        test('deserailize popout with no reference group', async () => {
            ...
            const windowObject = (panel2 === null || panel2 === void 0 ? void 0 : panel2.api.location.type) === 'popout'
                ? panel2 === null || panel2 === void 0 ? void 0 : panel2.api.location.getWindow()
                : undefined;
        ...
        test('grid -> floating -> popout -> popout closed', async () => {
            ...
            expect(panel3.api.location.type).toBe('grid');
            const windowObject = panel2.api.location.type === 'popout'
        ...
        test('popout / floating layouts', async () => {
            ...
            expect(dockview.panels.length).toBe(4);
            panel1 = dockview.api.getPanel('panel_1');
            panel2 = dockview.api.getPanel('panel_2');
            panel3 = dockview.api.getPanel('panel_3');
            panel4 = dockview.api.getPanel('panel_4');
            expect(panel1.api.location.type).toBe('grid');
            expect(panel2.api.location.type).toBe('popout');
            expect(panel3.api.location.type).toBe('floating');
            expect(panel4.api.location.type).toBe('popout');
        ...
        test('close popout window object', async () => {
            const container = document.createElement('div');
            const mockWindow = (0, mockWindow_1.setupMockWindow)();
        ...
        test('persistance with custom url', async () => {
            ...
            expect(await dockview.addPopoutGroup(panel2.group)).toBeTruthy();
            expect(await dockview.addPopoutGroup(panel3.group, {
    ...
    describe('panel visibility', () => {
        ...
        test('that watermark appears when all views are not visible', () => {
            ...
            let query = (0, dom_1.queryByTestId)(container, 'watermark-component');
            expect(query).toBeFalsy();
            panel1.group.api.setVisible(false);
            jest.runAllTicks(); // visibility events check fires on microtask-queue
            query = (0, dom_1.queryByTestId)(container, 'watermark-component');
            expect(query).toBeFalsy();
            panel2.group.api.setVisible(false);
            jest.runAllTicks(); // visibility events check fires on microtask-queue
            query = (0, dom_1.queryByTestId)(container, 'watermark-component');
    ...
    describe('addPanel', () => {
        ...
        test('panel moveTo with skipSetActive should not activate group', () => {
            ...
            expect((_a = dockview.activePanel) === null || _a === void 0 ? void 0 : _a.id).toBe(panel2.id);
            ...
            expect(dockview.activeGroup).toBe(panel2.group);
            expect((_b = dockview.activePanel) === null || _b === void 0 ? void 0 : _b.id).toBe(panel2.id);
            expect(panel1.group).toBe(panel2.group);
        });
    ...
    describe('GitHub Issue #991 - Group remains active after tab header space drag', () => {
        ...
        test('single panel group remains active after move to edge', () => {
            ...
            expect((_a = dockview.activePanel) === null || _a === void 0 ? void 0 : _a.id).toBe('panel1');
            ...
            expect(dockview.activePanel).toBeTruthy();
            expect((_b = dockview.activePanel) === null || _b === void 0 ? void 0 : _b.id).toBe('panel1');
