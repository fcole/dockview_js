...
const paneviewComponent_1 = require("../../paneview/paneviewComponent");
...
describe('paneviewComponent', () => {
    ...
    test('that the container is not removed when grid is disposed', () => {
        ...
        const paneview = new paneviewComponent_1.PaneviewComponent(container, {
