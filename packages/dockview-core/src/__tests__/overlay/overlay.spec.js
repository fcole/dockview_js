...
describe('overlay', () => {
    test('toJSON, top left', () => {
        ...
        const cut = new overlay_1.Overlay({
            height: 200,
            width: 100,
            left: 10,
            top: 20,
        ...
        jest.spyOn(container.childNodes.item(0), 'getBoundingClientRect').mockImplementation(() => {
            return (0, utils_1.mockGetBoundingClientRect)({
                left: 80,
                top: 100,
                width: 40,
                height: 50,
    ...
    test('setBounds, top left', () => {
        ...
        const element = container.querySelector('.dv-resize-container');
    ...
    test('aria-level attributes and corresponding z-index', () => {
        const container = document.createElement('div');
        const content = document.createElement('div');
        const createOverlay = () => new overlay_1.Overlay({
            height: 500,
            width: 500,
            left: 100,
            top: 200,
        ...
        const zIndexValue = (delta) => `calc(var(--dv-overlay-z-index, 999) + ${delta})`;
