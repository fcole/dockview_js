...
const gridviewComponent_1 = require("../../gridview/gridviewComponent");
const gridviewPanel_1 = require("../../gridview/gridviewPanel");
const lifecycle_1 = require("../../lifecycle");
const splitview_1 = require("../../splitview/splitview");
class TestGridview extends gridviewPanel_1.GridviewPanel {
...
describe('gridview', () => {
    ...
    test('update className', () => {
        const gridview = new gridviewComponent_1.GridviewComponent(container, {
    ...
    test('added views are visible by default', () => {
        ...
        expect(panel === null || panel === void 0 ? void 0 : panel.api.isVisible).toBeTruthy();
    });
    test('remove panel', () => {
        const gridview = new gridviewComponent_1.GridviewComponent(container, {
            proportionalLayout: false,
    ...
    test('deserialize and serialize a layout', () => {
        ...
        expect(panel1 === null || panel1 === void 0 ? void 0 : panel1.api.isVisible).toBeTruthy();
        expect(panel1 === null || panel1 === void 0 ? void 0 : panel1.api.id).toBe('panel_1');
        expect(panel1 === null || panel1 === void 0 ? void 0 : panel1.api.isActive).toBeTruthy();
        expect(panel1 === null || panel1 === void 0 ? void 0 : panel1.api.isFocused).toBeFalsy();
        expect(panel1 === null || panel1 === void 0 ? void 0 : panel1.api.height).toBe(400);
        expect(panel1 === null || panel1 === void 0 ? void 0 : panel1.api.width).toBe(300);
        expect(panel2 === null || panel2 === void 0 ? void 0 : panel2.api.isVisible).toBeFalsy();
        expect(panel2 === null || panel2 === void 0 ? void 0 : panel2.api.id).toBe('panel_2');
        expect(panel2 === null || panel2 === void 0 ? void 0 : panel2.api.isActive).toBeFalsy();
        expect(panel2 === null || panel2 === void 0 ? void 0 : panel2.api.isFocused).toBeFalsy();
        expect(panel2 === null || panel2 === void 0 ? void 0 : panel2.api.height).toBe(400);
        expect(panel2 === null || panel2 === void 0 ? void 0 : panel2.api.width).toBe(0);
        expect(panel3 === null || panel3 === void 0 ? void 0 : panel3.api.isVisible).toBeTruthy();
        expect(panel3 === null || panel3 === void 0 ? void 0 : panel3.api.id).toBe('panel_3');
        expect(panel3 === null || panel3 === void 0 ? void 0 : panel3.api.isActive).toBeFalsy();
        expect(panel3 === null || panel3 === void 0 ? void 0 : panel3.api.isFocused).toBeFalsy();
        expect(panel3 === null || panel3 === void 0 ? void 0 : panel3.api.height).toBe(400);
        expect(panel3 === null || panel3 === void 0 ? void 0 : panel3.api.width).toBe(500);
        panel2.api.setActive();
        expect(panel1.api.isActive).toBeFalsy();
        expect(panel2.api.isActive).toBeTruthy();
        expect(panel3.api.isActive).toBeFalsy();
    ...
    test('gridview events', () => {
        ...
        gridview.layout(800, 400);
        let events = [];
        const disposable = new lifecycle_1.CompositeDisposable(gridview.onDidAddGroup((group) => {
    ...
    test('fromJSON  events should still fire', () => {
        ...
        const disposable = new lifecycle_1.CompositeDisposable(gridview.onDidAddGroup((panel) => {
            addGroup.push(panel);
